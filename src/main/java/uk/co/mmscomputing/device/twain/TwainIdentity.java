...
//    jtwain.setINT32(identity,0,0);
  ...
  static public TwainIdentity[] getIdentities()throws TwainIOException{
    ...
    Vector<TwainIdentity> identities=new Vector<TwainIdentity>();
    try{
      ...
      System.out.println("com.example.smartdemo.twain.TwainIdentity.getIdentities:\n\t"+tioe);
    }
  ...
  static public String[] getProductNames()throws TwainIOException{
    ...
    try{
      ...
      System.out.println("com.example.smartdemo.twain.TwainIdentity.getProductNames:\n\t"+tioe);
    }
