...
public class PDFPage extends PDFDictionary{
  ...
  public void setMediaBox(int x,int y,int width,int height){
    ...
    mediaBox.add(new PDFInteger(x));            // lower-left (x,y)
    mediaBox.add(new PDFInteger(y));
    mediaBox.add(new PDFInteger(x+width/*-1*/));    // upper-right (x,y)
    mediaBox.add(new PDFInteger(y+height/*-1*/));
  ...
  public void setCropBox(int x,int y,int width,int height){
    ...
    cropBox.add(new PDFInteger(x));             // lower-left (x,y)
    cropBox.add(new PDFInteger(y));
    cropBox.add(new PDFInteger(x+width/*-1*/));     // upper-right (x,y)
    cropBox.add(new PDFInteger(y+height/*-1*/));
    put("CropBox",cropBox);
  }
