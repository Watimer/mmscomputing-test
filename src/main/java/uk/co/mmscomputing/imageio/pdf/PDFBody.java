...
public class PDFBody extends PDFObject{
  ...
  public PDFInteger getSize(){return new PDFInteger(list.getSize());}
  ...
  public PDFIndirectReference getDefaultFont(){  
    if(defaultFont==null){
      ...
      font.put("Subtype",new PDFName("Type1"));
      font.put("Name",new PDFName("defaultFont"));
      font.put("BaseFont",new PDFName("Helvetica"));
      font.put("Encoding",new PDFName("MacRomanEncoding"));
